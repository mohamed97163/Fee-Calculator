...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('fee_percentages', function (Blueprint $table) {
            $table->id();
            $table->foreignId('fee_preset_id')->nullable()->constrained()->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignId('service_id')->nullable()->constrained()->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignId('threshold_id')->nullable()->constrained()->cascadeOnDelete()->cascadeOnUpdate();
